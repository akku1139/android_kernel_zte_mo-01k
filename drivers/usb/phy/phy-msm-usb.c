...
//zhangjing add for otg connect
      char *disconnected[2] = { "OTG_STATE=OTG_DISCONNECTED", NULL };
	char *connected[2]    = { "OTG_STATE=OTG_CONNECTED", NULL };
...
kobject_uevent_env(&motg->phy.dev->kobj, KOBJ_CHANGE,
					   uevent_envp);
