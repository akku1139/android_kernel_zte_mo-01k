...
/*[CQID:000000] yaotierui fix the shutdown dead issue  begin 20170223,  */
static unsigned rebooting = 0; 
void set_rebooting_value(void)
{
    printk(KERN_EMERG "ytr set_rebooting_value.\n");
    rebooting = 1;
}

unsigned get_rebooting_value(void)
{
    return rebooting;
}
/*[CQID:000000] yaotierui fix the shutdown dead issue end 20170223,  */
		...
		enum led_brightness value)
{
	...
	/*[CQID:000000] yaotierui fix the shutdown dead issue begin 20170223,  */
        if(get_rebooting_value())
          {
        	pr_err("%s: ytr rebooting, quit sending LEDS set data \n", __func__);
		    return;
          }
    /*[CQID:000000] yaotierui fix the shutdown dead issue end 20170223,  */
