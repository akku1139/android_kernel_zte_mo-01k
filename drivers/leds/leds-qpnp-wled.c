...
static int qpnp_wled_set_level(struct qpnp_wled *wled, int level)
{
	...
	pr_err("[MSM_LCD]%s:level=%d\n",__func__,level);//yangchaofeng add log info
	return 0;
}
...
static int qpnp_wled_config(struct qpnp_wled *wled)
{
	...
	/*ZSW_MODIFY begin,modify for backlevel flash,yangchaofeng,20170421*/
	reg = 0x30; //reg = 0x00;
	/*ZSW_MODIFY end,modify for backlevel flash,yangchaofeng,20170421*/
	rc = qpnp_wled_write_reg(wled, &reg,
