...
#endif
//add by zsw wkh begin
if (_gProcTouchscreenInfo)
		#if (LINUX_VERSION_CODE >= KERNEL_VERSION(3, 10, 0))
			proc_remove(_gProcTouchscreenInfo);
			_gProcTouchscreenInfo = NULL;
		#else
			remove_proc_entry(NULL, _gProcTouchscreenInfo);
		#endif
//add by zsw wkh end
#if FTS_SYSFS_NODE_EN
